...
/**
 * Send an email that would notify the user that an item was included in the cart
 * @param {obj} email - email address
 * @param {obj} product - object that contains the product selected by the customer to be added into the cart
 */
 function sendAddCartProductEmail(email,product) {
    ...
    emailHelpers.sendEmail(emailObj, 'mail/addItemEmailTemplate', product);
}
...
module.exports = {
    ...
    sendAddCartProductEmail: sendAddCartProductEmail
};
